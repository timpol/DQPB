...
GuiSettingsMap = {
    ...
    'task':                    {'default': 'Concordia-intercept age', 'widget': 'taskCombo'},
    'data_type':               {'default': 'Tera-Wasserburg' ,'widget': 'dataTypeCombo'},
    ...
    'fig_border_color':        {'default': 'whitesmoke', 'widget': 'figBorderColorCombo'},
    ...
    'conc_intercept_ellipse':  {'default': True,       'widget': 'interceptEllipseOpt'},
    'conc_intercept_points':   {'default': False,      'widget': 'interceptMarkersOpt'},
    ...
    'conc_intercept_marker_alpha':      {'default': '0.1', 'widget': 'mcMarkerAlphaEntry'},
